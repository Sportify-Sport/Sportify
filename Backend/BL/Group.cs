namespace Backend.BL
{
    public class Group
    {
        ...
        public Group() { }
        public Group(int groupId, string groupName, string description, int sportId, string groupImage, int cityId, DateTime foundedAt, int maxMemNum, int totalMembers, int minAge, string gender)
        {
