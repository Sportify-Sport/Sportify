...
export default function NotificationsScreen() {
  const { token, NotificationService, unreadCount, setUnreadCount, isGuest, logout, isEmailVerified } = useAuth();
  ...
  }, [token, isGuest, isEmailVerified]);

// Fetch new notifications when screen is focused
useFocusEffect(
  React.useCallback(() => {
    if (token && !isGuest && isEmailVerified) {
